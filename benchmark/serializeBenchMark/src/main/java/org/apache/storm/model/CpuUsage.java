...
import org.apache.storm.util.LinuxShellUitl;
        ...
        try {
            ...
            while((line=in1.readLine()) != null){
                if(line.startsWith("cpu")){
                    ...
                    log.debug("IdleCpuTime: " + idleCpuTime1 + ", " + "TotalCpuTime" + totalCpuTime1);
                    break;
                }
            }
            in1.close();
            ...
            while((line=in2.readLine()) != null){
                if(line.startsWith("cpu")){
                    ...
                    log.debug("IdleCpuTime: " + idleCpuTime2 + ", " + "TotalCpuTime" + totalCpuTime2);
                    break;
                }
            }
            if(idleCpuTime1 != 0 && totalCpuTime1 !=0 && idleCpuTime2 != 0 && totalCpuTime2 !=0){
                cpuUsage = 1 - (float)(idleCpuTime2 - idleCpuTime1)/(float)(totalCpuTime2 - totalCpuTime1);
                log.debug("本节点CPU使用率为: " + cpuUsage);
            }
            in2.close();
