 ...
 * NASDAQ股票交易Topology
 * storm jar NASDAQStockDeal-2.0.0-SNAPSHOT.jar org.apache.storm.StockDealTopology StockDealTopology stockdealTopic_comm 30 1 60
 */
public class StockDealTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setSpout(KAFKA_SPOTU_ID, new StockDealSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER,topic)), spoutInstancesNum);
...
//                new Fields("topic", "partition", "offset", "key", "value"), TOPIC_2_STREAM);
        return KafkaSpoutConfig.builder(bootstrapServers, new String[]{topic})
                .setProp(ConsumerConfig.GROUP_ID_CONFIG, "StockDealGroup")
