 ...
 */
public class StockeDealLatencySpout<K, V> extends KafkaSpout<K, V> {
    private Timer timer;
    ...
    private Logger LOG= LoggerFactory.getLogger(StockeDealLatencySpout.class);

    public StockeDealLatencySpout(KafkaSpoutConfig<K, V> kafkaSpoutConfig) {
