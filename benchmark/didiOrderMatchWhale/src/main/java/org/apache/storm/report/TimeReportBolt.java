 ...
 * 计算输出结果第二列和第三列的平均值函数：cat time.out | awk '{sum1+=$3;sum2+=$4;sum3+=$5;sum4+=$6;sum5+=$7;sum6+=$8;sum7+=$9;count++}END{print sum1/count,sum2/count,sum3/count,sum4/count,sum5/count,sum6/count,sum7/count}'
 */
public class TimeReportBolt extends BaseRichBolt {
    ...
    public static final String fileName="/whale/time.out";
    //public static final String fileName="/home/TJ/time.out";
