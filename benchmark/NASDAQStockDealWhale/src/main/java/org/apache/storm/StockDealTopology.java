...
public class StockDealTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setBolt(STACKDEAL_BOLT_ID, new StockDealBolt(),boltInstancesNum).allGrouping(KAFKA_SPOTU_ID,SPOUT_STREAM_ID);
...
//                new Fields("topic", "partition", "offset", "key", "value"), TOPIC_2_STREAM);
        return KafkaSpoutConfig.builder(bootstrapServers, new String[]{topic})
                .setProp(ConsumerConfig.GROUP_ID_CONFIG, "StockDealWhaleGroup")
