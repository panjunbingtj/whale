 ...
 * storm jar didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderMatchThroughputTopology DiDiOrderMatchThroughputTopology ordersTopic 30 1 60
 */
public class DiDiOrderMatchThroughputTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setSpout(KAFKA_SPOTU_ID, new DiDiOrdersThroughputSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER,topic)), spoutInstancesNum);
