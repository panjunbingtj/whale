...
public class TupleImpl implements Tuple {
    ...
    public void setStartSerializingTime(long startSerializingTime) {
        this.startSerializingTime = startSerializingTime;
    }

    public void setEndSerializingTime(long endSerializingTime) {
        this.endSerializingTime = endSerializingTime;
    }

    public void setStartDeserializingTime(long startDeserializingTime) {
        this.startDeserializingTime = startDeserializingTime;
    }

    public void setEndDeserializingTime(long endDeserializingTime) {
        this.endDeserializingTime = endDeserializingTime;
    }
